...
class AdventureParkEntity(context: Context, entity: AdventurePark): BaseEntity() {
    ...
    init {
        ...
        properties = listOf(
            ...
            HeaderedProperty(context.getString(R.string.property_carpet_title), entity.Prices ?: context.getString(R.string.property_not_found))
        )
    }
